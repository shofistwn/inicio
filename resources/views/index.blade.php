                ...
                <div class="row align-items-center review-slider normal-slider">
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/alatdokter.png') }}" href=""
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/alatbantudengar.png') }}"
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/alatbantujalan.png') }}"
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/rapidtest.png') }}"
                                    style="width: 100px; height: 100px;">
                            </a>
                            <p>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/p3k.png') }}" style="width: 100px; height: 100px;">
                            </a>
                            <p>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/model.png') }}" style="width: 100px; height: 100px;">
                            </a>
                            <p>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/kursiroda.png') }}"
                                    style="width: 100px; height: 100px;">
                            </a>
                            <p>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="width: 110px; border: 0;">
                            <a href="">
                                <img src="{{ asset('assets/img/shop/termometer.png') }}"
                                    style="width: 100px; height: 100px;">
                            </a>
                            <p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-latest-news">
                            ...
                            <div class="news-text-box">
                                ...
                                <a type="button" class="latest-brand1" data-toggle="modal" data-target="#exampleModal-{{ $artikel->id }}">
                                    Read More...
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">{{ $artikel->judul }}</h5>
