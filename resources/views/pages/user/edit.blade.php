        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="card-header py-3">
                    <a href="{{ route('beranda') }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i>&nbsp; Back</a>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <select class="form-control provinsi-asal" name="provinsi">
                                    ...
                                    <option value="{{ $province }}" {{ $user->provinsi == $province ? 'selected' : ''
                                        }}>
                                        {{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <select class="form-control kota-tujuan" name="kota">
                                    ...
                                    <option value="{{ $key }}" {{ $user->kota == $key ? 'selected' : '' }}>
                                        {{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 list-1">
                                ...
                                <textarea class="form-control" rows="2" id="textarea"
                                    placeholder="Rt / Rw / Desa / Jalan / Gang"
